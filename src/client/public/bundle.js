...
/***/ function(module, exports, __webpack_require__) {
	...
	var BattleshipApp = React.createClass({
		...
		getStartRowAndIndex: function getStartRowAndIndex(orientation, length) {
			var startIndex,
			    startRow,
			    rowAndIndex = {};
	...
	(0, _reactDom.render)(React.createElement(BattleshipApp, null), document.getElementById('app'));
